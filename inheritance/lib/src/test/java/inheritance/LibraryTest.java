...
class LibraryTest {
    ...
    @Test void shopClassTest(){
        ...
        newShop.shopReview("humam","i like this place",4);
        assertEquals("Shop{name='Target', description='All things you need', stars=4.0, dollarSigns='$$$$', reviews=[humam ( said: i like this place, and rate it with =4.0 stars ]}",newShop.toString());
    }
    ...
    @ Test void theaterClassTest(){
        ...
        newTheater.addReview("humam","i like the theater design",5);
        assertEquals("Theater{name='cima', stars=5.0, movies=[Inception], reviews=[humam ( said: i like the theater design, and rate it with =5.0 stars ]}",newTheater.toString());


        //adding a review with mention a movie name
        newTheater.addReview("somebody","nice movie i love it",4,"inception");
        assertEquals("Theater{name='cima', stars=4.5, movies=[Inception], reviews=[humam ( said: i like the theater design, and rate it with =5.0 stars , somebody ( said: nice movie i love it, and rate it with =4.0 stars ,movie name: inception)]}",newTheater.toString());
